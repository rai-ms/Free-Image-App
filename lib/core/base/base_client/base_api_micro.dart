...
class GetApiMicro<T> with BaseMicro {
  ...
  Future<Response> call({
    ...
    return await apiHandler.dioHandler(
      apiCall:  () async {
        return await ApiService.service.dio.get(endPoint,
...
class PostApiMicro with BaseMicro{
  Future<Response> call({
    ...
    return apiHandler.dioHandler(
      apiCall: () async {
        return await ApiService.service.dio.post(endPoint,
          queryParameters: queryParam,
          onReceiveProgress: onReceiveProgress,
...
class PatchApiMicro  with BaseMicro {
  Future<Response> call({
    ...
    return apiHandler.dioHandler(
        apiCall: () async {
          return await ApiService.service.dio.patch(endPoint,
              queryParameters: queryParam,
              onReceiveProgress: onReceiveProgress,
              onSendProgress: onSendProgress,
              data: body,
...
class UploadStreamApiMicro  with BaseMicro {
  Future<Response> postBinaryData({
    ...
    final stream = Stream.fromIterable(data.map((e) => [e])); // Creates a Stream<List<int>>.
      ...
      apiCall: () async {
        if(options != null){
          ...
          options.headers?.addAll({
            Headers.contentLengthHeader: contentLength, // Set the content-length.
          });
        }
        return await ApiService.service.dio.post(
          url,
