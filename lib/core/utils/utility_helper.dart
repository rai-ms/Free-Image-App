...
// Check Internet
  ...
  static CachedNetworkImage image(img,
    ...
    return CachedNetworkImage(
      ...
      progressIndicatorBuilder: (BuildContext imageContext, String value, DownloadProgress progress) {
        return GlowLoader(
  ...
  static String formatJoinDate(String joinDate) {
    DateTime dateTime =
        DateTime.fromMillisecondsSinceEpoch(int.parse(joinDate));
